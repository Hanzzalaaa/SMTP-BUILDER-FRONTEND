...
type SignupStep = "email" | "otp" | "name" | "success"
    ...
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="space-y-4 lg:space-y-6">
        ...
        <Button
          ...
          className="w-full h-12 lg:h-14 text-base lg:text-lg bg-gradient-to-r from-orange-400 to-yellow-500 hover:from-orange-500 hover:to-yellow-600 text-white font-medium"
        >
          {loading ? (
            <>
              <Loader2 className="w-4 h-4 lg:w-5 lg:h-5 mr-2 animate-spin" />
    ...
    <div className="text-center space-y-6 lg:space-y-8">
      ...
      <div className="space-y-3 lg:space-y-4">
        ...
        <p className="text-base lg:text-lg text-gray-600 dark:text-gray-400 max-w-md mx-auto">
          Your SMTPMAILER account has been verified and is ready to use.
        </p>
        {user?.plan && (
      ...
      <div className="space-y-3 lg:space-y-4">
        <Button
          ...
          className="w-full h-12 cursor-pointer lg:h-14 text-base lg:text-lg bg-gradient-to-r from-orange-400 to-yellow-500 hover:from-orange-500 hover:to-yellow-600 text-white font-medium"
        >
          Go to Dashboard
          <ArrowRight className="w-4 h-4 lg:w-5 lg:h-5 ml-2" />
        </Button>
